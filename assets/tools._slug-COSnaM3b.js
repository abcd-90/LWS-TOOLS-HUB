...
export const FEATURED_TOOLS_DATA = [
  ...
  },
  {
    ...
    savings: "Save 75%",
    delivery_time: "5 - 15 Minutes Instant Delivery",
    warranty_text: "4 months Validity • 30-Day Replacement Guarantee",
    description: "Professional UI/UX website design creation in Adobe Photoshop with a clean, modern, and premium layout. Designed for high-quality user experience using a white and red color palette, balanced typography, and pixel-perfect composition.",
    icon_url: "https://upload.wikimedia.org/wikipedia/commons/a/af/Adobe_Photoshop_CC_icon.svg",
    ...
    features: [
      ...
      "Vector Masking & Selection Tools",
      "4K & 8K Ultra HD Export",
      "Full Camera Raw & Color Grading",
      "Official Adobe Creative Cloud Access"
    ],
    faqs: [
      { q: "How fast will I receive my Photoshop access?", a: "Access details are delivered to your email & WhatsApp within 5 to 15 minutes of payment verification." },
      { q: "Is there a replacement warranty?", a: "Yes, you get full 30-day replacement warranty and 4 months validity support." },
      { q: "Can I use Generative Fill & AI tools?", a: "Yes, all premium AI features including Generative Fill are 100% active." },
